...
<head>
    ...
    <title>Precision Notary Services | Professional Mobile Notary</title>
    <meta name="description" content="Professional notary services for loan signings, real estate documents, legal papers, and more. Mobile notary available. Schedule your appointment today.">
...
<body>
            ...
            <div class="logo">
                <div class="logo-icon">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-1 2l5 5h-5V4zM8 17h8v-1H8v1zm0-3h8v-1H8v1zm0-3h5v-1H8v1z"/>
                    </svg>
                </div>
                <h1>Hartonotary</h1>
                <p class="tagline">Professional • Reliable • Convenient</p>
            </div>
            <p class="hero-description">
                Trusted notary services for all your important documents. 
                From loan signings to legal paperwork, we bring professional 
    ...
    <section class="services-section" id="services">
        <div class="container">
            ...
            <p class="section-subtitle">Comprehensive notary services tailored to your needs</p>
        ...
        <div class="container">
            ...
            <div class="calendly-wrapper">
                ...
                <div class="calendly-inline-widget" 
                     data-url="https://calendly.com/konradky?hide_gdpr_banner=1&primary_color=0F3524"
        ...
        <div class="container">
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    ...
                    <p>Reach out to us for any inquiries about our notary services. We typically respond within 24 hours.</p>
                    ...
                    <ul class="contact-details">
                        ...
                        <li>
                            ...
                            <span><a href="mailto:hartonotary@gmail.com">hartonotary@gmail.com</a></span>
                        </li>
                        <li>
                    ...
                    <form id="contactForm" action="process_contact.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select id="service_type" name="service_type">
                                    ...
                                    <option value="real_estate">Real Estate Documents</option>
                                    <option value="power_of_attorney">Power of Attorney</option>
                                    <option value="affidavit">Affidavit</option>
                                    <option value="will_trust">Will / Trust</option>
                                    <option value="medical_directive">Medical Directive</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="message" name="message" required 
                                      placeholder="Please describe your notary needs, preferred dates/times, and any questions you may have..."
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-logo">Hartonotary</div>
            <p>Professional Notary Services You Can Trust</p>
            <div class="footer-bottom">
                <p>&copy; <?php echo date('Y'); ?> Hartonotary. All rights reserved.</p>